...
**Toplam 655 madde · 481 tamamlandı · 174 kaldı**
...
| Faz 7 — Klasör tabanlı Tx/Rx kayıt mimarisi ve TOML şema | 1 | 79 | 80 |
...
### Faz 7 — Klasör tabanlı Tx/Rx kayıt mimarisi ve TOML şema (1/80)
