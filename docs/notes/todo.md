...
**Toplam 492 madde · 11 tamamlandı · 481 kaldı**
...
| --- | --- | --- | --- |
| Faz 0 — Keşif ve format sözleşmesi | 11 | 6 | 17 |
...
### Faz 0 — Keşif ve format sözleşmesi (11/17)
...
| [ ] | `F0-012` | `0.12.0` | 20 dk | Referans mockup'ın dokuz bölgesini yerleşime eşleştir |
...
| | İş | Sürüm | Süre | Çıktı |
| --- | --- | --- | --- | --- |
| [ ] | `F1-001` | `0.18.0` | 20 dk | Python paket iskeleti ve bağımlılık kilidini oluştur |
...
| [ ] | `F1-006` | `0.23.0` | 20 dk | Windows kalite kontrol iş akışını ekle |
| [ ] | `F1-007` | `0.24.0` | 20 dk | Uygulama girişini ve temiz kapanışı ekle |
| [ ] | `F1-008` | `0.25.0` | 20 dk | Merkezi exception yakalama yolunu ekle |
| [ ] | `F1-009` | `0.26.0` | 20 dk | Sürümlü temel ayarları yükle ve kaydet |
| [ ] | `F1-010` | `0.27.0` | 20 dk | Dönen log ve session kimliği ekle |
| [ ] | `F1-011` | `0.28.0` | 15 dk | ChannelMetadata modelini tanımla |
| [ ] | `F1-012` | `0.29.0` | 15 dk | DataChunk ve kalite alanlarını tanımla |
