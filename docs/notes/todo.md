...
**Toplam 655 madde · 485 tamamlandı · 170 kaldı**
...
| Faz 7 — Klasör tabanlı Tx/Rx kayıt mimarisi ve TOML şema | 5 | 75 | 80 |
...
### Faz 7 — Klasör tabanlı Tx/Rx kayıt mimarisi ve TOML şema (5/80)
