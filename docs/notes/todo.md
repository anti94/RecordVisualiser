...
**Toplam 655 madde · 484 tamamlandı · 171 kaldı**
...
| Faz 7 — Klasör tabanlı Tx/Rx kayıt mimarisi ve TOML şema | 4 | 76 | 80 |
...
### Faz 7 — Klasör tabanlı Tx/Rx kayıt mimarisi ve TOML şema (4/80)
