...
Son yürütme: `4.0.0` → `3.8.0`, **12 adımın 12'si geçti**.
...
`tools/rollback_check.py`, `4.0.0` → `3.8.0` geri dönüşünü yürüttü:

| # | Adım | Sonuç |
| --- | --- | --- |
| 1 | Yeni sürüm kurulur | **TAMAM** |
| 2 | Yeni sürüm çalışıyor (`sonar-analyzer 4.0.0`) | **TAMAM** |
